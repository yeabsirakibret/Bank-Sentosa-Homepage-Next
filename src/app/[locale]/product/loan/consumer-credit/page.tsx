...
export default async function ConsumerCredit() {
  ...
  return(
    <div className={`${geistSans.className} w-full flex flex-col`}>
        <div className="p-8 bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 text-white shadow-2xl">
            <h1 className="text-3xl">{t('consumer_credit')}</h1>
        </div>
        ...
        <div className='flex flex-col md:flex-row gap-4 justify-center items-center mx-12 my-8'>
            ...
            <div className="aspect-[4/3] w-full max-w-md rounded-lg overflow-hidden">
                <img src="/bank_sentosa_pinjaman_kredit_konsumtif-01.png" alt="Investment Credit" className="w-full h-full object-cover" />
            </div>
            ...
            <div className=''>
                <div className='flex flex-col md:mx-10 mx-2'>
                    ...
                    <p>
                        {t('consumer_credit_description')}
                    </p>

                    <p className='mt-2 font-bold'>
                        {t('personal_credit_usage')}:
                    </p>
                    <ul className="max-w-md space-y-1 text-gray-600 list-disc list-inside ">
                        <li>
                            {t('usage_home_purchase')}
                        </li>
                        <li>
                            {t('usage_home_build')}
                        </li>
                        <li>
                            {t('usage_home_renovation')}
                        </li>
                        <li>
                            {t('usage_vehicle')}
                        </li>
                        <li>
                            {t('usage_education_religion')}
                        </li>
                        <li>
                            {t('usage_others')}
                        </li>
